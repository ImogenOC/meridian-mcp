...
$requests.Add((New-Call 3 'dm_parse_environment' @{ dme_path = (Join-Path $riftRoot 'tgstation.dme') }))
$requests.Add((New-Call 4 'dm_check_errors' @{}))
$id = 10
...
foreach ($responseId in @(1, 2, 3, 4) + (10..$lastId)) {
