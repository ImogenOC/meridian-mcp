...
| Tracy live capture | Technical BYOND fixture using repository-supported `-params tracy` | BYOND 516.1685 Windows, then Ubuntu independently | Prepared hook hash, loopback endpoint, known proc/file/line, `ServerTick` frames, bounded atomic trace, cancellation, and clean stop | Live fixture and hosted evidence are not yet recorded | Experimental |
